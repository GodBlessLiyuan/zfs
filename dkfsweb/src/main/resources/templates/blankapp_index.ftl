                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#insertModal" data-whatever="@getbootstrap">添加黑名单
                            </button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">新黑白名单</h5>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <span for="message-text" class="col-form-label">应用名<span
                                                                style="color: red">*</span>:</span>
                                                    <input type="text" class="form-control" id="iAppName">
                                                </div>
                                                <div class="form-group">
...
<script>
    ...
    function queryClick() {
        ...
        $('#datatab').DataTable({
            ...
            "ordering": false, // 禁用排序
            "ajax": "blankapp/query?packageName=" + $('#packageName').val(),
