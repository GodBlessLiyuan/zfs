...
#### 13. 微信购买商品wxbuycommodity ####


	- url: http://server_addr/pay/v1.0/wxbuycommodity
	- method:POST
	- 请求消息示例：
...
#### 26. 支付宝购买商品alibuycommodity ####


	- url: http://server_addr/pay/v1.0/alibuycommodity
	- method:POST
	- 请求消息示例：
...
#### 27. 订单查询状态buystatus ####
	...
	- url: http://server_addr/pay/v1.0/buystatus
	- method:POST
	- 请求消息示例：
