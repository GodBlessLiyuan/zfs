...
#### 13. 微信购买商品wxpayorder ####
	...
	- url: http://server_addr/pay/v1.0/wxpayorder
	- method:POST
	- 请求消息示例：
...
- url: http://server_addr/share/v1.0/sharecode
	- method:POST
	- 请求消息示例：
...
- url: http://server_addr/smart/v1.0/uploadpic
	- method:POST
	- 请求消息示例：
...
#### 26. 支付宝购买商品alipayorder ####
	...
	- url: http://server_addr/pay/v1.0/alipayorder
	- method:POST
	- 请求消息示例：
...
#### 27. 订单查询状态paystatus ####
   	...
   	- url: http://server_addr/pay/v1.0/paystatus
   	- method:POST
   	- 请求消息示例：
...
#### 28. 语音盒子分享####
	...
	- url: http://server_addr/voice/v1.0/share
	- method:POST
	- 请求消息示例：
...
#### 29. 语音上传 ####
    ...
    - url: http://server_addr/voice/v1.0/upload
	- method:POST
	- 请求消息示例：
