...
<body>
    <div class="item">
        <div class="title" style="font-weight: bolder">悬浮窗如何开启？</div>
        <input type="checkbox">
        <span class="ico"></span>
    ...
    <div class="item">
        <div class="title" style="font-weight: bolder">辅助服务如何开启？</div>
        <input type="checkbox">
        <span class="ico"></span>
        <div class="content" style="font-size: 15px">
    ...
    <div class="item">
        <div class="title" style="font-weight: bolder">微信支持版本</div>
        <input type="checkbox">
        <span class="ico"></span>
        <div class="content" style="font-size: 15px">
