                       ...
                       <caption class="font_reward" style="font-size: 15px;font-weight: bolder">会员规则如下，未勾选表示无权使用：</caption>
                        <thead>
                            <tr >
                                ...
                                <td style="vertical-align: middle;text-align: center">VIP会员</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr >
                                <td style="vertical-align: middle;text-align: center">好友验证</td>
                                <td style="vertical-align: middle; text-align: center"><img src="${basePath}/images/check_redbag.png"/></td>
                                <td style="vertical-align: middle; text-align: center"><img src="${basePath}/images/check_redbag.png"/></td>
                            </tr>
                            <tr >
                            ...
                            <tr >
                                ...
                                <td style="vertical-align: middle; text-align: center"><img src="${basePath}/images/ico_delete_youshang.png"/></td>
                                <td style="vertical-align: middle; text-align: center"><img src="${basePath}/images/check_redbag.png"/></td>
                            </tr>
                            <tr >
